...
def spec_augment(mel_spectrogram, time_warping_para=40, frequency_masking_para=27,
    ...
    """
    mel_spectrogram = mel_spectrogram.unsqueeze(0) #torch.Size([353, 680]) --> torch.Size([1, 353, 680]) # 353 : feature 높이 
    ...
    # Step 1 : Time warping
    #warped_mel_spectrogram = time_warp(mel_spectrogram) ## Error depends on Pytorch, Not recommend to use
