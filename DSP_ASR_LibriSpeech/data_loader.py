...
class SpectrogramDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.SAflag :
            self.save_test_img(index, spect, "spec_Before" ,basePoint = 360) 
            #print(index)
            ##########################
            # SpecAugment : 
            time_warping_para= 0 # Not used
            frequency_masking_para=15
            time_masking_para= 45
            ...
            self.save_test_img(index, spect, "spec_After" ,basePoint = 360)
